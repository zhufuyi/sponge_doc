...
sponge创建的web和微服务支持docker部署，部署在本机的docker容器上，需要本地安装有[docker服务](https://www.docker.com/)和[docker-compose命令](https://github.com/docker/compose/releases)，切换到服务代码目录，部署命令：
