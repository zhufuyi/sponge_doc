...
虽然在rpc网关服务可以连接到微服务，但是不知道可以调用微服务哪些api接口，所以需要明确告诉rpc网关服务有哪些接口可以调用。

把微服务代码目录的`api/微服务名称/v1/xxx.proto`文件复制出来，并移动到rpc网关服务代码目录下`api/微服务名称/v1/xxx.proto`。有了微服务proto文件，rpc网关服务就可以知道有哪些api接口可以调用了。
